...
export default function KaiblePrivacyPolicy() {
  return (
    <main className="min-h-screen bg-stone-900 text-stone-50">
      <div className="mx-auto max-w-3xl px-6 pt-24 md:pt-28 pb-12 text-left">
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-amber-400 mb-2">kAIble Privacy Policy</h1>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Summary</h2>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Data We Do Not Collect</h2>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">On‑Device Processing</h2>
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Local Storage</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Optional Diagnostics</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">No Advertising & No Tracking</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Children’s Privacy</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Your Choices</h2>
          <ul className="list-disc pl-6 space-y-2 text-stone-200 text-left">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Third‑Party Services</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Security</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">International Use</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Changes to This Policy</h2>
          <p className="text-stone-200">
        ...
        <section className="mt-10 space-y-4">
          <h2 className="text-2xl font-semibold text-amber-300">Contact</h2>
          <p className="text-stone-200">
            Questions about privacy? Contact us at <a className="text-amber-400 hover:text-amber-300 underline" href="mailto:kaihedrick@icloud.com">kaihedrick@icloud.com</a>.
          </p>
        </section>
